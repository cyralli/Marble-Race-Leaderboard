...
# FFMPEG
VERY IMPORTANT! make sure you have ffmpeg AS YOUR ENVIROMENT VARIABLE. If you run cmd and type ffmpeg in there, and it recognizes that code. It means you already have ffmpeg.  
